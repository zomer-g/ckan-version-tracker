...
The report is read-only (catalog functions); the hash compaction writes.
Every dataset stays queryable in SQL: nothing here moves rows out of it.
"""
import logging
import time
...
# ── Shrinking: compact the dedup hashes ──────────────────────────────────────
