...
async def _tool_search_donations(request, db, user, a) -> tuple[dict, int]:
    ...
    return {
        ...
        "note": ("שם תורם אינו מזהה ייחודי — ייתכנו כמה אנשים באותו שם, ואותו אדם "
                 "בכמה איותים. כמו כן, שתי שורות זהות לחלוטין אינן כפילות: המרשם "
                 "מכיל דיווחים חוזרים אמיתיים — אותו תורם, אותו סכום, אותו מקבל, "
                 "באותו יום — שדווחו כשני פרסומים נפרדים, והספירה של המרשם עצמו "
                 "מונה אותם כשניים."),
    }, len(rows)
