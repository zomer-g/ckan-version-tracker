...
TOOLS: list[dict] = [
    {
        "name": "search_deals",
        "description": (
            "העסקאות עצמן, מסוננות וממוינות. כל תשובה נושאת גם console_sql "
    ...
    },
    {
        "name": "price_series",
        "description": (
            "מספר העסקאות וחציון השווי לכל שנה, תחת אותם מסננים בדיוק כמו "
    ...
    },
    {
        ...
        "description": (
            ...
            "אחת, והשינוי באחוזים. זה הכלי לשאלות 'איפה עלה הכי הרבה' או "
    ...
    },
    {
        ...
        "description": (
            "47 מהויות העסקה שבמאגר, עם מספר העסקאות וחציון השווי בכל אחת. "
